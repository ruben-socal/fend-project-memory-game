/* wrap all the code in a function for use strict, which is used to catch errors that
   javascript would normally allow */
(function () {
  "use strict";
...
/* addHTMLCards function adds 16 <li> class cards with child <i> to class deck */
function addHTMLCards(cardList) {
    var htmlCard = '';
    $(".gameWinPanel").hide();
    for(var i=0; i<16; i++ ){
        htmlCard = '<li class="card"><i class=\"'+cardList[i]+'\"></i></li>';
...
/* hideGameWinDisplay function hides game win display */
function hideGameWinDisplay() {
    $(".gameWinPanel").hide();
}
...
/* startTimer function starts the timer for the game */
function startTimer() {
...
/* resetTime function resets the time for the time function startTimer*/
function resetTime() {
    hour=0; min=0; seconds=0;
}
 ...
 */
/* addCardEvents function adds click event listeners to cards */
function addCardEvents() {
    // Attach a directly bound event handler
    /* cards are created dynamically so class deck is called to create click events on class card */
